<template>
	<div>
		...
		<section id="learn_about" v-if="this.aboutUsData !== null">
			<about-comp :picVert="this.aboutUsData[1].pic1" :picHor="this.aboutUsData[1].pic2" :title="this.aboutUsData[1].title" 
			:text1="this.aboutUsData[1].text1" :text2="this.aboutUsData[1].text2" h2Id="title_page_about" itemId="page_about_item"
			:buttonText="this.aboutUsData[1].button" linkTo="ContactPage">
			</about-comp>
		</section>
