...
<!-- featured section------------------------------------------------------------------ -->
			...
			<div class="featured_project_2">
				...
				<div class="content_over_video">
					<div class="text_wrap text_white align_l">
						...
						<router-link :to="{ name: 'ProjectN', params: { id: this.projectData[1].id } }" class="arrow text_white">
		...
		<section id="featured_project_3">
			<featured-pr-comp :title="this.projectData[2].title" :id='this.projectData[2].id'
				textClass="project_text_1 text_black" :text="this.projectData[2].descr" :pic="this.projectData[2].pic1"
				linkClass="text_black" underlineClass="menu_link">
			</featured-pr-comp>
		</section>
			...
			<div class="container w100">
				<div class="project_content_wrap gap15">
					<div class="text_wrap project_text_4">
						...
						<router-link :to="{ name: 'ProjectN', params: { id: this.projectData[3].id } }" class="arrow"><span
								class="menu_link text_black">View Project</span>
							<span>
								<svg width="30" height="10" viewBox="0 0 30 10" xmlns="http://www.w3.org/2000/svg">
									<path
										d="M0 6.09375V4.51562L27.7031 4.57812L26.2656 2.78125L26.25 0.625L30 5.3125L26.25 9.96875L26.2344 7.95312L27.6875 6.17188L0 6.09375Z"
