<template>
	<div v-if="item !== null">
		...
		<section class="container">
			<div class="project_info">
				<div class="project_titles">
					...
					<span>
						<h1><sup>({{ item.id }})</sup>{{ item.company }}</h1>
					</span>
				</div>
		...
		<section class="project_video" v-if="item.video !== 'N/A'">
			<div class="container">
				<div class="video_wrap">
					<a v-show="!this.isVideo" href="#" class="load_video" @click.stop.prevent="this.isVideo = true">
						<img :src="require('@/assets/images/poster_' + item.video + '.jpg')" alt="video screenshot" />
					</a>
					<video v-if="this.isVideo" autoplay loop muted controls :title="item.title"
		...
		<section class="next">
			<div class="container">
				<router-link :to="{ name: 'ProjectN', params: { id: this.nextPageId } }" class="next_project_btn"
					target="_blank"> Next Project
					<span>
						<svg width="50" height="40" viewBox="0 0 30 10" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path class="svg_white"
